...
def initCurrent(): #init with second trade and more
    ...
    print('initCurrent()  positSh: ' + str(positSh) + '; qtyStep: ' + str(qtyStep))
    ...
    print('initCurrent()  positLng: ' + str(positLng) + '; qtyStep: ' + str(qtyStep) + '; cnfg.positLng[cnfg.loopItems] : ' + str(cnfg.positLng[cnfg.loopItems]))
    ...
    print('initCurrent()  cnfg.costTP_Long: ' + str(cnfg.costTP_Long) + '; cnfg.costSL_Long: ' + str(cnfg.costSL_Long))
