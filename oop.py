...
#------- for Down
        ...
        self.cmbFtrDnTP_Lng1.current(7)
...
#         self.cmbFtrDnSl_Sh2.grid(column=13, row=2,  sticky='E')
        ...
        self.cmbFtrDnTP_Lng2.current(7)
        ...
        self.cmbFtrDnSl_Lng2.current(7)
